...
class MapaInferiorConfig {
    ...
    public $sitio_titulo = 'GIISI';
    public $logotipo     = 'imagenes/siigi.png';
    ...
    public function html() {
        ...
        if ($this->en_raiz) {
            ...
            $a[] = '            <a href="a-cerca/index.html">A cerca</a> | ';
        ...
        $a[] = '            <a class="fa fa-github-square"      href="https://github.com/giisi" target="_blank"></a>';
